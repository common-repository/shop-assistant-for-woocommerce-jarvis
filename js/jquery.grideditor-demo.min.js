...
!function (a) {
    ...
    }), E = p.create(['<div class="note-popover popover bottom in">', '  <div class="arrow"/>', '  <div class="popover-content note-children-container"/>', "</div>"].join("")), F = function (a, b) {
    ...
    var U = function (a) {
        ...
        var c = this, e = /^(https?:\/\/|ssh:\/\/|ftp:\/\/|file:\/|www\.|(?:mailto:)?[A-Z0-9._%+-]+@)(.+)$/i;
        this.events = {
        ...
        this.initialize = function () {
            ...
            this.$dialog = d.dialog({title: g.image.insert, body: j, footer: k}).render().appendTo(b)
        }, this.destroy = function () {
            d.hideDialog(this.$dialog), this.$dialog.remove()
        }, this.bindEnterKey = function (a, b) {
            a.on("keypress", function (a) {
        ...
        this.initialize = function () {
            ...
            this.$dialog = d.dialog({title: g.video.insert, body: c, footer: h}).render().appendTo(b)
        }, this.destroy = function () {
            d.hideDialog(this.$dialog), this.$dialog.remove()
        }, this.bindEnterKey = function (a, b) {
            a.on("keypress", function (a) {
        ...
        this.createShortCutList = function () {
            var c = f.keyMap[j.isMac ? "mac" : "pc"], d = a("<div />");
            return Object.keys(c).forEach(function (e) {
                var f = a('<div class="help-list-item"/>'), g = c[e], h = b.memo("help." + g) ? b.memo("help." + g) : g, i = a("<label />").css({
                    width: 180,
                    "max-width": 200,
                    "margin-right": 10
                }).html(e), j = a("<span />").html(h);
                f.html(i).append(j), d.append(f)
            }), d.html()
        }, this.initialize = function () {
            var b = f.dialogsInBody ? a(document.body) : e, c = ['<p class="text-center">', '<a href="//summernote.org/" target="_blank">Summernote 0.7.1</a> � ', '<a href="//github.com/summernote/summernote" target="_blank">Project</a> � ', '<a href="//github.com/summernote/summernote/issues" target="_blank">Issues</a>', "</p>"].join("");
            this.$dialog = d.dialog({
        ...
        var e = this, f = a.summernote.ui, g = b.options.hint || [], h = a.isArray(g) ? g : [g];
        this.events = {
            "summernote.keyup": function (a, b) {
            ...
            this.lastWordRange = null, this.$popover = f.popover({className: "note-hint-popover"}).render().appendTo("body"), this.$content = this.$popover.find(".popover-content"), this.$content.on("click", ".note-hint-item", function () {
            ...
            var a = this.$content.find(".note-hint-item.active"), c = this.nodeFromItem(a);
            ...
            var b = h[a.data("index")], c = a.data("item"), d = b.content ? b.content(c) : c;
            ...
            if (d.contains([I.code.ENTER, I.code.UP, I.code.DOWN], a.keyCode)) {
                ...
                var f = b.invoke("editor.createRange").getWordRange(), g = f.toString();
                if (h.length && g) {
                    this.$content.empty();
